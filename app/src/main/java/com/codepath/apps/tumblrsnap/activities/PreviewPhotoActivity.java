...
public class PreviewPhotoActivity extends FragmentActivity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.filter_glow:
			...
			break;
        case R.id.filter_warp:
            effectId =ImageFilterProcessor.WARP;
            break;
        case R.id.filter_contrast:
            effectId = ImageFilterProcessor.CONTRAST;
            break;
        case R.id.filter_tritone:
            effectId = ImageFilterProcessor.TRITONE;
            break;
		default:
			effectId = ImageFilterProcessor.NONE;
			break;
